...
| Agents | `.claude/agents/` | 28 sub-agents (5 utility incl. Hakim post-consolidation + 7 engineering + 1 architecture (Tariq) + 6 product-design + 5 security-data + 4 marketing). Per AgDR-0050, the #347 PR 3 Hatim→Hakim consolidation decision, AgDR-0054 (Solution Architect), and AgDR-0053 (marketing department). |
